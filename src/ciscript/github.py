...
class Secrets(CustomBaseModel):
    description: Annotated[
        Optional[str],
        Field(description="A string description of the secret parameter."),
    ] = None
    required: Annotated[
        Any,
        Field(description="A boolean specifying whether the secret must be supplied."),
    ]


class WorkflowCallEvent(CustomBaseModel):
    inputs: Annotated[
        Optional[Dict[str, Inputs]],
        Field(
...
class Inputs(CustomBaseModel):
    ...
    description: Annotated[
        str, Field(description="A string description of the input parameter.")
    ]
    deprecationMessage: Annotated[
        Optional[str],
        Field(description="A string shown to users using the deprecated input."),
    ] = None
    required: Annotated[
        Optional[bool],
        Field(
    ...
    type: Annotated[
        Optional[Literal["string", "choice", "boolean", "environment"]],
        Field(description="A string representing the type of the input."),
    ] = None
    options: Annotated[
        Optional[List[str]],
        Field(
...
class Environment(CustomBaseModel):
    ...
    name: Annotated[
        str, Field(description="The name of the environment configured in the repo.")
    ]
    url: Annotated[Optional[str], Field(description="A deployment URL")] = None
...
class RefItem(CustomBaseModel):
    pass


Shell = Annotated[
    Literal["bash", "pwsh", "python", "sh", "cmd", "powershell"],
    Field(
...
class Strategy(CustomBaseModel):
    ...
    matrix: Annotated[
        Union[Dict[str, List[str]], ExpressionSyntax],
        Field(
...
class Defaults(CustomBaseModel):
...
RefOrRefItem = Union[Ref, RefItem]


class ReusableWorkflowCallJob(CustomBaseModel):

    name: Annotated[
        Optional[str], Field(description="The name of the job displayed on GitHub.")
    ] = None
    ...
    secrets: Annotated[
        Optional[Union[Env, Literal["inherit"]]],
        Field(
    ...
    concurrency: Annotated[
        Optional[Union[str, Concurrency]],
        Field(
...
class Step(CustomBaseModel):
    ...
    name: Annotated[
        Optional[str], Field(description="A name for your step to display on GitHub.")
    ] = None
    uses: Annotated[
        Optional[str],
        Field(
...
class OnItems(CustomBaseModel):
    branch_protection_rule: Annotated[
        Optional[Union[BranchProtectionRuleEvent, EmptyEvent]],
        Field(
    ...
    pull_request: Annotated[
        Optional[Union[PullRequestEvent, EmptyEvent]],
        Field(
    ...
    pull_request_review_comment: Annotated[
        Optional[EventObject],
        Field(
    ...
    push: Annotated[
        Optional[Union[PushEvent, EmptyEvent]],
        Field(
    ...
    workflow_call: Annotated[
        Optional[WorkflowCallEvent],
        Field(description="Allows workflows to be reused by other workflows."),
    ] = None
    workflow_dispatch: Annotated[
        Optional[WorkflowDispatch],
        Field(
...
class Container(CustomBaseModel):
    ...
    env: Annotated[
        Optional[Env],
        Field(description="Sets an array of environment variables in the container."),
    ] = None
    ports: Annotated[
...
Permissions = Annotated[
    Union[Literal["read-all", "write-all"], PermissionsEvent],
    Field(
...
class Job(CustomBaseModel):
    ...
    environment: Annotated[
        ...
        Field(description="The environment that the job references."),
    ] = None
    outputs: Annotated[
...
class Workflow(CustomBaseModel):
    ...
    on: Annotated[
        Union[Event, List[Event], OnItems],
        Field(
    ...
    jobs: Annotated[
        Dict[str, Union[Job, ReusableWorkflowCallJob]],
        Field(
